...
window.RaidList = [
    ...
    new RaidData("Colossus Omega (HL)", 300491, RAID_TIER.Magna, 101, 2, null, [47], [3], ELEMENTS.fire, "2040034000_high.png"),
    ...
    new RaidData("Leviathan Omega (HL)", 300511, RAID_TIER.Magna, 101, 2, null, [48], [3], ELEMENTS.water, "2040028000_high.png"),
    ...
    new RaidData("Yggdrasil Omega (HL)", 300531, RAID_TIER.Magna, 101, 2, null, [49], [3], ELEMENTS.earth, "2040027000_high.png"),
    ...
    new RaidData("Luminiera Omega (HL)", 300561, RAID_TIER.Magna, 101, 2, null, [50], [3], ELEMENTS.light, "2040047000_high.png"),
    ...
    new RaidData("Celeste Omega (HL)", 300581, RAID_TIER.Magna, 101, 2, null, [51], [3], ELEMENTS.dark, "2040046000_high.png"),
