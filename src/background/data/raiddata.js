...
function RaidData(name, jName, id, tier, minHostRank, dailyHosts, apCost, matIDs, matNums, ele, thumb) {
    let mats;
    this.urls = {};
    ...
    this.name = name;
    this.jName = jName; // Coop use, sometimes shortened.
    this.id = id;
    this.tier = tier;
...
window.RaidList = [
    ...
    new RaidData("Raphael", "ラファ", 303081, RAID_TIER.Primarch, 40, 1, 50, [5341], [2], ELEMENTS.wind, "2040202000_multi.png"),
    ...
    new RaidData("Michael", "ミカ", 303101, RAID_TIER.Primarch, 40, 1, 50, [5311], [2], ELEMENTS.fire, "2040200000_multi.png"),
    ...
    new RaidData("Gabriel", "ガブ", 303091, RAID_TIER.Primarch, 40, 1, 50, [5321], [2], ELEMENTS.water, "2040201000_multi.png"),
    ...
    new RaidData("Uriel", "ウリエル", 303111, RAID_TIER.Primarch, 40, 1, 50, [5331], [2], ELEMENTS.earth, "2040203000_multi.png"),
    ...
    new RaidData("Prometheus", "プロメテウス", 302751, RAID_TIER.Epic, 101, 1, 80, [41], [1], ELEMENTS.fire, "2040125000_high.png"),
    new RaidData("Ca Ong", "カー・オン", 303041, RAID_TIER.Epic, 101, 1, 80, [42], [1], ELEMENTS.water, "2040160000_high.png"),
    new RaidData("Gilgamesh", "ギルガ", 302711, RAID_TIER.Epic, 101, 1, 80, [43], [1], ELEMENTS.earth, "2040130000_high.png"),
    new RaidData("Morrigna", "バイヴカハ", 303051, RAID_TIER.Epic, 101, 1, 80, [44], [1], ELEMENTS.wind, "2040122000_high.png"),
    new RaidData("Hector", "ヘクトル", 303061, RAID_TIER.Epic, 101, 1, 80, [45], [1], ELEMENTS.light, "2040144000_high.png"),
    new RaidData("Anubis", "アヌビス", 303071, RAID_TIER.Epic, 101, 1, 80, [46], [1], ELEMENTS.dark, "2040134000_high.png"),

    new RaidData("Shiva", "シヴァ", 303151, RAID_TIER.Genesis, 120, 2, 90, [522], [1], ELEMENTS.fire, "2040185000_high.png"),
    new RaidData("Europa", "エウロペ", 303161, RAID_TIER.Genesis, 120, 2, 90, [523], [1], ELEMENTS.water, "2040225000_high.png"),
    new RaidData("Godsworn Alexiel", "ゴブロ", 303171, RAID_TIER.Genesis, 120, 2, 90, [524], [1], ELEMENTS.earth, "2040205000_high.png"),
    new RaidData("Grimnir", "グリム", 303181, RAID_TIER.Genesis, 120, 2, 90, [525], [1], ELEMENTS.wind, "2040261000_high.png"),
    new RaidData("Metatron", "メタトロン", 303191, RAID_TIER.Genesis, 120, 2, 90, [526], [1], ELEMENTS.light, "2040276000_high.png"),
    new RaidData("Avatar", "アバター", 303221, RAID_TIER.Genesis, 120, 2, 90, [527], [1], ELEMENTS.dark, "2040277000_high.png"),

    new RaidData("Bahamut", "よわバハ", 300291, RAID_TIER.Nightmare, 80, 3, 80, [58], [1], ELEMENTS.dark, "2030002000_hell.png"),
    new RaidData("Grand Order", "グランデ", 301051, RAID_TIER.Nightmare, 80, 2, 80, [82], [1], ELEMENTS.light, "2040065000_hell.png"),
    new RaidData("Grand Order (HL)", "グランデHL", 305161, RAID_TIER.Nightmare, 150, 1, 90, [83], [1], ELEMENTS.noEle, "2040065000_high.png"),
    new RaidData("Huanglong", "黄龍", 301671, RAID_TIER.Nightmare, 80, 1, 80, [6005], [1], ELEMENTS.light, "2040157000_hell.png"),
    new RaidData("Qilin", "黒麒麟", 301681, RAID_TIER.Nightmare, 80, 1, 80, [6005], [1], ELEMENTS.dark, "2040158000_hell.png"),
    new RaidData("Bahamut (HL)", "つよバハ", 301061, RAID_TIER.Nightmare, 101, 1, 90, [59], [1], ELEMENTS.dark, "2040128000_hell.png"),
    new RaidData("Huanglong & Qilin (HL)", "黄龍・黒麒麟HL", 303231, RAID_TIER.Nightmare, 120, 1, 90, [6005], [2], ELEMENTS.light, "2040157000_high.png"),
    new RaidData("Akasha", "アーカーシャ", 303251, RAID_TIER.Nightmare, 150, 1, 90, [533], [3], ELEMENTS.light, "2040308000_high.png"),
    new RaidData("The Four Primarchs", "四大天司HL", 303291, RAID_TIER.Primarch, 120, 1, 80, [[5311, 5321, 5331, 5341]], [[1, 1, 1, 1]], ELEMENTS.noEle, "30329.png"),

    new RaidData("Rose Queen", "ローズ", 300471, RAID_TIER.Ancient, 101, 1, 50, [1204], [10], ELEMENTS.wind, "2040105000_high.png"),

    new RaidData("Ultimate Bahamut", "アルバハ", 303131, RAID_TIER.Ultimate, 80, 1, 80, [133], [1], ELEMENTS.noEle, "2040223000.png"),
    new RaidData("Tiamat Malice", "ティアマリス", 303241, RAID_TIER.Epic, 120, 1, 80, [104, 106], [5, 5], ELEMENTS.wind, "2040307000_high.png"),
    new RaidData("Ultimate Bahamut (HL)", "アルバハHL", 303141, RAID_TIER.Ultimate, 130, 1, 100, [136], [1], ELEMENTS.noEle, "2040223000_high.png"),

    new RaidData("Dark Rapture", "ルシファー", 303271, RAID_TIER.Nightmare, 120, 1, 80, [[506, 507, 508, 509]], [[1, 1, 1, 1]], ELEMENTS.noEle, "2040056000.png"),
    new RaidData("Dark Rapture (Hard)", "ルシHL", 303281, RAID_TIER.Rapture, 170, 1, 100, [537], [1], ELEMENTS.noEle, "2040056000_high.png"),
